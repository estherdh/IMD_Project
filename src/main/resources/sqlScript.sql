...
ALTER TABLE QuestTypeLanguage
  ADD CONSTRAINT FK_QuestTypeLanguage_Language
FOREIGN KEY (LanguageId) REFERENCES Language (LanguageId);

ALTER TABLE QuestTypeLanguage
  ADD CONSTRAINT FK_QuestTypeLanguage_QuestType
FOREIGN KEY (QuestTypeId) REFERENCES QuestType (QuestTypeId);

ALTER TABLE QuestLog
  ADD CONSTRAINT FK_QuestLog_User
FOREIGN KEY (UserId) REFERENCES Users (UserId)
  ON DELETE CASCADE
  ON UPDATE CASCADE;

ALTER TABLE QuestLog
  ADD CONSTRAINT FK_QuestLog_QuestType
FOREIGN KEY (QuestTypeId) REFERENCES QuestType (QuestTypeId);

ALTER TABLE QuestProperties
  ADD CONSTRAINT FK_QuestProperties_QuestLog
FOREIGN KEY (EntryId) REFERENCES QuestLog (EntryId)
  ON DELETE CASCADE
  ON UPDATE RESTRICT;

ALTER TABLE ExhibitInfo
  ADD CONSTRAINT FK_ExhibitInfo_Exhibit
FOREIGN KEY (ExhibitId) REFERENCES Exhibit (ExhibitId);

ALTER TABLE ExhibitInfo
  ADD CONSTRAINT FK_ExhibitInfo_Language
FOREIGN KEY (LanguageId) REFERENCES Language (LanguageId);
...
ALTER TABLE Exhibit
  ADD CONSTRAINT FK_Exhibit_Museum
FOREIGN KEY (MuseumId) REFERENCES Museum (MuseumId);

ALTER TABLE Exhibit
  ADD CONSTRAINT FK_Exhibit_Era
FOREIGN KEY (EraId) REFERENCES Era (EraId);

ALTER TABLE ExhibitTags
  ADD CONSTRAINT FK_ExhibitTags_Exhibit
FOREIGN KEY (ExhibitId) REFERENCES Exhibit (ExhibitId);

ALTER TABLE ExhibitTags
  ADD CONSTRAINT FK_ExhibitTags_Tags
...
VALUES (4, 1, 'Voorbeeld streektaal',
        'Dit papier bevat een stuk tekst in streektaal: Oet de goaldn korenaarn skeup God de Tweantenaarn, en oet t kaf en d restn de leu oet t Westn',
        'object.png'),
