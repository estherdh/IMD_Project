...
public class QuestJDBCDaoTest {
    ...
    public void getQuestsFromUserTestSuccess() throws Exception {
        ...
        Quest expectedQuest2 = new Quest(1, "(NL)Stuur tekst", null, 15, 1, 0, 0, new QrScanQuest(new HashMap<>()));
        Quest expectedQuest1 = new Quest(2, "(EN)Scan qr code", null, 10, 1, 0, 0, new QrScanQuest(new HashMap<>()));
        //test
